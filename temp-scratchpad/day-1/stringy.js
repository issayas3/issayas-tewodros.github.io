 ...
 */
 function toDashCase(string) {
    // YOUR CODE BELOW HERE //
  //Replace parameter's spaces for dashes
  //Replaces spaces for dashes
var dashed = string.replaceAll(' ', '-');
//Create output variable
  var output = '';
//Iterate through string to lowercase then add to output
  for (var i = 0; i < dashed.length; i++) {
     output += dashed[i].toLowerCase()
  }
  //return
return output;
    // YOUR CODE ABOVE HERE //
...
function beginsWith(string, char) {
    ...
    if (string[0] === char || string[0] === char.toUpperCase()) {
        return true;
    } else {
        return false;
    }
